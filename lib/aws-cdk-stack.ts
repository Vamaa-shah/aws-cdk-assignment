...
export class AwsCdkStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // Create an S3 Bucket
    const myBucket = new s3.Bucket(this, 'vshah3026-MyFirstBucket', {
      versioned: true,
      removalPolicy: cdk.RemovalPolicy.DESTROY,  // Only for dev/test environments
    });
 
    // Create a Lambda Function
    const myLambda = new lambda.Function(this, 'vshah3026-MyLambda', {
    ...
    const myTable = new dynamodb.Table(this, 'vshah3026-MyTable', {
